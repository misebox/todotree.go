...
//			AddTaskFunc: func(ctx context.Context, title string, parentID *entity.TaskID) (*entity.Task, error) {
...
func (mock *AddTaskServiceMock) AddTask(ctx context.Context, title string, parentID *entity.TaskID) (*entity.Task, error) {
	...
	return mock.AddTaskFunc(ctx, title, parentID)
}
...
//			RegisterUserFunc: func(ctx context.Context, name string, email string, password string, role string) (*entity.User, error) {
...
func (mock *RegisterUserServiceMock) RegisterUser(ctx context.Context, name string, email string, password string, role string) (*entity.User, error) {
	...
	return mock.RegisterUserFunc(ctx, name, email, password, role)
}
